...
**Bounded by a 120 s hard timeout** in the LLM client
...
layers = [
    ...
    ("LLM timeouts",    "Daemon-thread 120s hard cap per call",             PALETTE["llm"],     7.8),
...
bounded by this timeout.  Default is 120 s for the client-level
cap; specific nodes (plan_reviewer, clarifier) have an outer 135
